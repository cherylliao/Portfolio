      ...
      <Container noGutter mobileGutter width="1200px">
        <Box {...row}>
          <Box {...contentArea}>
            ...
            <Heading content="Cheryl Liao" {...nameStyle} />
            <Heading content="Fullstack Developer" {...designationStyle} />
            <Box {...roleWrapper}>
              <Icon
                ...
                size={22}
              />
              <Heading content="ReactJS, MongoDB, MERN Stack" {...roleStyle} />
            </Box>
            <Text
              content="Functional paradigm allows clean maintainable code and sharing logic throughout the app."
              {...aboutStyle}
            />
